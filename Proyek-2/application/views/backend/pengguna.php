			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
						...
						<li class="nav-item">
							<a href="<?=site_url();?>administrator/pengguna" class="nav-link active">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a class="btn btn-secondary btn-sm" href="<?=site_url();?>administrator/tambah-pengguna">
				...
				<div class="card">
					<div class="card-body p-0">
						<table class="table table-striped projects text-center">
							...
							<tbody>
                                <?php foreach ($array_pengguna as $pengguna): ?>
								<tr>
									<td>
									...
									<td class="project-actions">
										<a class="btn btn-info btn-sm" href="<?=site_url("administrator/edit-pengguna/"  . $pengguna->id);?>">
											<i class="fas fa-pencil-alt">
											</i>
											Edit
										</a>
										<a class="btn btn-danger btn-sm" href="<?=site_url("administrator/hapus-pengguna/" . $pengguna->id);?>">
