...
<head>
	...
	<title>SITAPO | Tambah Jenis Wisata</title>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<!-- form start -->
								<form action="<?=site_url();?>administrator/proses-tambah-jenis-wisata" method="post">
									<div class="card-body">
										<div class="form-group">
											<label>Nama</label>
											<input type="text" name="nama" class="form-control" placeholder="Nama Jenis Wisata">
										</div>
									</div>
									<!-- /.card-body -->
