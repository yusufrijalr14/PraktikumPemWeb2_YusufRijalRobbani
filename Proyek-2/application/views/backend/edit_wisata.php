...
<head>
	...
	<title>SITAPO | Edit Tempat Wisata</title>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<!-- form start -->
								<form action="<?=site_url("administrator/proses-edit-wisata/" . $tempat_wisata->id);?>" method="post" enctype="multipart/form-data">
									<div class="card-body">
                                        <input type="hidden" name="id" value="<?php echo $tempat_wisata->id ?>">
                                        
										<div class="form-group">
											<label>Nama</label>
											<input type="text" name="nama" class="form-control" placeholder="Nama Tempat Wisata" value="<?php echo $tempat_wisata->nama ?>">
										</div>
										<div class="form-group">
											<label>Alamat</label>
											<input type="text" name="alamat" class="form-control" placeholder="Alamat" value="<?php echo $tempat_wisata->alamat ?>">
										</div>
										<div class="form-group">
											<label>Latitude, Longitude</label>
											<input type="text" name="latlong" class="form-control" placeholder="Latitude, Longitude" value="<?php echo $tempat_wisata->latlong ?>">
										</div>
										<div class="form-group">
											<label>Jenis</label>
											<select class="form-control" name="jenis_id">
                                                <option value="<?php echo $jenis_wisata_selected->id ?>" selected><?php echo $jenis_wisata_selected->nama ?></option>
                                                <?php foreach ($array_jenis_wisata as $jenis_wisata): ?>
                                                    <option value="<?php echo $jenis_wisata->id ?>"><?php echo $jenis_wisata->nama ?></option>
                                                <?php endforeach; ?>
											</select>
										</div>
										<div class="form-group">
											<label>Skor Rating</label>
											<input type="text" name="skor_rating" class="form-control" placeholder="Skor Rating" value="<?php echo $tempat_wisata->skor_rating ?>">
										</div>
										<div class="form-group">
											<label>Harga Tiket</label>
											<input type="number" name="harga_tiket" class="form-control" placeholder="Harga Tiket" value="<?php echo $tempat_wisata->harga_tiket ?>">
										</div>
										<div class="form-group">
											<label>Foto 1</label>
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="kecamatan_id">
                                                <option value="<?php echo $kecamatan_selected->id ?>" selected><?php echo $kecamatan_selected->nama ?></option>
										...
										<div class="form-group">
											<label>Website</label>
											<input type="text" name="website" class="form-control" placeholder="Website" value="<?php echo $tempat_wisata->website ?>">
										</div>
										<div class="form-group">
											<label>Fasilitas</label>
											<input type="text" name="fasilitas" class="form-control" placeholder="Fasilitas" value="<?php echo $tempat_wisata->fasilitas ?>">
										</div>
									</div>
									<!-- /.card-body -->
