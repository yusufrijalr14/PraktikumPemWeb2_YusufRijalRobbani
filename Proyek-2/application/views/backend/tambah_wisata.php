...
<head>
	...
	<title>SITAPO | Tambah Tempat Wisata</title>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<!-- form start -->
								<form action="<?=site_url();?>administrator/proses-tambah-wisata" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="form-group">
											<label>Nama</label>
											<input type="text" name="nama" class="form-control" placeholder="Nama Tempat Wisata">
										</div>
										<div class="form-group">
											<label>Alamat</label>
										...
										<div class="form-group">
											...
											<input type="text" name="latlong" class="form-control" placeholder="Latitude, Longitude">
										</div>
										<div class="form-group">
											<label>Jenis</label>
										...
										<div class="form-group">
											...
											<input type="text" name="skor_rating" class="form-control" placeholder="Skor Rating">
										</div>
										<div class="form-group">
											<label>Harga Tiket</label>
											<input type="number" name="harga_tiket" class="form-control" placeholder="Harga Tiket">
										</div>
										<div class="form-group">
											<label>Foto 1</label>
