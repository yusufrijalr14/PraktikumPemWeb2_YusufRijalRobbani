...
<head>
	...
	<title>SITAPO | Edit Kecamatan</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a class="btn btn-secondary btn-sm" href="<?=site_url();?>administrator/kecamatan">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<!-- form start -->
								<form action="<?=site_url("administrator/proses-edit-kecamatan/" . $kecamatan->id);?>" method="post">
									<div class="card-body">
                                        <input type="hidden" name="id" value="<?php echo $kecamatan->id ?>">
										<div class="form-group">
											<label>Nama</label>
											<input type="text" name="nama" class="form-control" placeholder="Nama Kecamatan" value="<?php echo $kecamatan->nama ?>">
										</div>
									</div>
									<!-- /.card-body -->
