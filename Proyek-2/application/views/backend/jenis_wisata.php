...
<head>
	...
	<title>SITAPO | Jenis Wisata</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a class="btn btn-secondary btn-sm" href="<?=site_url();?>administrator/tambah-jenis-wisata">
					...
					<div class="card-body p-0">
						<table class="table table-striped projects text-center">
							...
							<tbody>
								...
								<tr>
									<td>
                                        <?php echo $jenis_wisata->id ?>
									</td>
									<td>
                                        <?php echo $jenis_wisata->nama ?>
									</td>									
									<td class="project-actions">
										<a class="btn btn-info btn-sm" href="<?=site_url("administrator/edit-jenis-wisata/"  . $jenis_wisata->id);?>">
											<i class="fas fa-pencil-alt">
											</i>
											Edit
										</a>
										<a class="btn btn-danger btn-sm" href="<?=site_url("administrator/hapus-jenis-wisata/" . $jenis_wisata->id);?>">
