...
<head>
	...
	<title>SITAPO | Tempat Wisata</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a class="btn btn-secondary btn-sm" href="<?=site_url();?>administrator/tambah-wisata">
					...
					<div class="card-body p-0">
						<table class="table table-striped projects text-center">
							...
							<tbody>
								...
								<tr>
									<td>
                                        <?php echo $tempat_wisata->id ?>
									</td>
									<td>
                                        <?php echo $tempat_wisata->nama ?>
									</td>
									<td>
                                        <?php echo $tempat_wisata->alamat ?>
									</td>
									<td>
										<?php echo $tempat_wisata->skor_rating ?>
									</td>
									<td class="project-actions text-right">
										<a class="btn btn-primary btn-sm" href="<?=site_url("administrator/detail-wisata/" . $tempat_wisata->id);?>">
											<i class="fas fa-folder">
											</i>
											Detail
										</a>
										<a class="btn btn-info btn-sm" href="<?=site_url("administrator/edit-wisata/"  . $tempat_wisata->id);?>">
											<i class="fas fa-pencil-alt">
											</i>
											Edit
										</a>
										<a class="btn btn-danger btn-sm" href="<?=site_url("administrator/hapus-wisata/" . $tempat_wisata->id);?>">
