...
<head>
	...
	<title>SITAPO | Edit Pengguna</title>
				...
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a class="btn btn-secondary btn-sm" href="<?=site_url();?>administrator/pengguna">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<!-- form start -->
								<form action="<?=site_url("administrator/proses-edit-pengguna/" . $pengguna->id);?>" method="post">
									<div class="card-body">
										<input type="hidden" name="id" value="<?php echo $pengguna->id ?>">
										<div class="form-group">
											<label>Username</label>
											<input type="text" name="username" class="form-control"
												placeholder="Username" value="<?php echo $pengguna->username ?>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<select class="form-control" name="status">
												<option value="<?php echo $pengguna->status ?>">
                                                <?php 
